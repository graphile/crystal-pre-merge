...
enable you to make broad changes to your GraphQL schema with minimal code.

Graphile Build has strong built-in support for
[Graphile Crystal](../graphile-crystal/README.md) so you can make an
exceptionally performant autogenerated (or generator-assisted) GraphQL API.

[PostGraphile](https://github.com/graphile/postgraphile) uses Graphile Build and
Graphile Crystal to provide an extremely high performance standards-compliant
GraphQL API with minimal fuss. The separate
