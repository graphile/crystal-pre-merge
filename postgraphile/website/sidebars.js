...
const sidebars = {
  docs: [
    ...
    },
    {
      ...
      items: [
        "extending/make-add-inflectors-plugin",
        "extending/make-change-nullability-plugin",
        "extending/make-extend-schema-plugin",
        "extending/make-process-schema-plugin",
        "extending/make-wrap-plans-plugin",
        "extending/make-add-pg-table-condition-plugin",
        "extending/make-add-pg-table-order-by-plugin",
        "extending/make-pg-smart-tags-plugin",
        "extending/extending-raw",
        "extending/plugin-gallery",
        "extending/community-plugins",
      ],
    },
    "plugins",
    {
