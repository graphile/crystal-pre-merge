...
as [connections](./tables/connections.md) or lists, depending on the behavior configuration.
...
[`makeExtendSchemaPlugin`](./extending/make-extend-schema-plugin.md) instead.
